...
# SSL is disabled for Fly.io internal network (.flycast) - asyncpg requires "disable" not False
if settings.is_production:
    engine = create_async_engine(
        ...
        connect_args={"ssl": "disable"},  # Disable SSL for Fly.io internal network (asyncpg requires "disable")
    )
else:
    ...
    engine = create_async_engine(
        ...
        pool_pre_ping=True,  # Verify connections before using them
        connect_args={"ssl": "disable"},  # Disable SSL for local development (asyncpg requires "disable")
    )
